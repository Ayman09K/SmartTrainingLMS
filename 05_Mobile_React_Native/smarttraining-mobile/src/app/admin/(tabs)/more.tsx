...
const sections: readonly AdminToolSection[] = [
  {
    title: "Organisation",
    description: "Structurez le catalogue, les parcours et les cohortes.",
    icon: {
    ...
    tools: [
      {
        ...
        description: "Construire, organiser et publier les parcours.",
      ...
      },
      {
        ...
        description: "Piloter les groupes et leurs membres.",
        href: "/admin/groups",
        icon: {
          ios: "person.3.fill",
          android: "groups",
      ...
      {
        label: "Catégories",
        description: "Gérer le référentiel des formations.",
  ...
  {
    title: "Gouvernance",
    description: "Traitez les demandes, retours et contrôles.",
    icon: {
    ...
    tools: [
      {
        ...
        description: "Valider ou refuser les demandes d’accès.",
      ...
      {
        label: "Feedbacks",
        description: "Consulter et traiter les retours utilisateurs.",
      ...
      },
      {
        ...
        description: "Suivre les demandes de suppression.",
  ...
  },
  {
    ...
    description: "Notifications, profil et préférences administrateur.",
    icon: {
    ...
    tools: [
      {
        label: "Notifications",
        description: "Consulter les événements liés à votre activité.",
      ...
      {
        label: "Mon compte",
        description: "Gérer votre identité et vos informations.",
        href: "/admin/profile",
        icon: {
          ios: "person.crop.circle.fill",
          android: "account_circle",
      ...
      {
        label: "Apparence",
        description: "Personnaliser le thème et la couleur.",
...
export default function AdminMoreRoute() {
  ...
  // Même logique responsive que l'espace Formateur.
  ...
  return (
    ...
    >
      {/* Hero — même langage visuel que l'espace Formateur. */}
      <View
      ...
      {/* Fonction conservée, simplement sortie de la grille comme côté Formateur. */}
      <Pressable
        accessibilityRole="button"
