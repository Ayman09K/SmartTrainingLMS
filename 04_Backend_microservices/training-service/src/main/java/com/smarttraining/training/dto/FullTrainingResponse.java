...
public class FullTrainingResponse {
    ...
    private List<FullModuleResponse> modules;

    public FullTrainingResponse() {
    }

    public FullTrainingResponse(Training training, List<FullModuleResponse> modules) {
    ...
    public List<FullModuleResponse> getModules() { return modules; }
}
